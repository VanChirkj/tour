...
function eventKrpanoLoaded (isWebVr) {
	...
	ktools.I18N.getInstance().initLanguage(tourLanguage, crossDomainTargetUrl+'shitdata/shit_messages_','.xml');
	krpanoLoaded = true;
...
function eventTourChangeLanguage (pLang) {
	...
	ktools.I18N.getInstance().initLanguage(pLang, crossDomainTargetUrl+'shitdata/shit_messages_','.xml');
}
...
function addKolorMenu(pPlugID) 
{
	...
	{
		var kolorMenuCSS = new ktools.CssStyle("KolorMenuCSS", crossDomainTargetUrl+"shitdata/graphics/KolorMenu/kolorMenu.css");
		var kolorMenuJS = new ktools.Script("KolorMenuJS", crossDomainTargetUrl+"shitdata/graphics/KolorMenu/KolorMenu.min.js", [], true);
	...
	if(mapsApiLength > 0){
		...
		if (mapsApiLength > 1 && mapApiOrder[1]) {
			...
			if (mapsApiLength > 2 && mapApiOrder[2]) {
				...
				var mapstractionScript = new ktools.Script("maps_mapstraction", crossDomainTargetUrl+"shitdata/graphics/KolorMap/lib/mxn.js"+refreshIE, [mapApiScript3], false);
				var mapstractionScriptBase = new ktools.Script("maps_mapstraction_base", crossDomainTargetUrl+"shitdata/graphics/KolorMap/lib/mxn.basemap.js", [mapstractionScript], false);
				var mapstractionScriptCore = new ktools.Script("maps_mapstraction_core", crossDomainTargetUrl+"shitdata/graphics/KolorMap/lib/mxn.core.js"+refreshIE, [mapstractionScriptBase], false);
				var mapstractionScriptCoreLayer3 = new ktools.Script("maps_mapstraction_core_layer3", crossDomainTargetUrl+"shitdata/graphics/KolorMap/lib/"+mapApiOrder[2][3]+refreshIE, [mapstractionScriptCore], false);
				var mapstractionScriptCoreLayer2 = new ktools.Script("maps_mapstraction_core_layer2", crossDomainTargetUrl+"shitdata/graphics/KolorMap/lib/"+mapApiOrder[1][3]+refreshIE, [mapstractionScriptCoreLayer3], false);
				var mapstractionScriptCoreLayer1 = new ktools.Script("maps_mapstraction_core_layer1", crossDomainTargetUrl+"shitdata/graphics/KolorMap/lib/"+mapApiOrder[0][3]+refreshIE, [mapstractionScriptCoreLayer2], false);
			} else {
				if(mapsApiLength > 2){
					var tmp_counter = mapLoadedCounter.item(pluginName) - 1;
					mapLoadedCounter.update(pluginName, tmp_counter);
				}
				var mapstractionScript = new ktools.Script("maps_mapstraction", crossDomainTargetUrl+"shitdata/graphics/KolorMap/lib/mxn.js"+refreshIE, [mapApiScript2], false);
				var mapstractionScriptBase = new ktools.Script("maps_mapstraction_base", crossDomainTargetUrl+"shitdata/graphics/KolorMap/lib/mxn.basemap.js", [mapstractionScript], false);
				var mapstractionScriptCore = new ktools.Script("maps_mapstraction_core", crossDomainTargetUrl+"shitdata/graphics/KolorMap/lib/mxn.core.js"+refreshIE, [mapstractionScriptBase], false);
				var mapstractionScriptCoreLayer2 = new ktools.Script("maps_mapstraction_core_layer2", crossDomainTargetUrl+"shitdata/graphics/KolorMap/lib/"+mapApiOrder[1][3]+refreshIE, [mapstractionScriptCore], false);
				var mapstractionScriptCoreLayer1 = new ktools.Script("maps_mapstraction_core_layer1", crossDomainTargetUrl+"shitdata/graphics/KolorMap/lib/"+mapApiOrder[0][3]+refreshIE, [mapstractionScriptCoreLayer2], false);
			}
		} else {
			if(mapsApiLength > 1){
			...
			var mapstractionScript = new ktools.Script("maps_mapstraction", crossDomainTargetUrl+"shitdata/graphics/KolorMap/lib/mxn.js"+refreshIE, [mapApiScript], false);
			var mapstractionScriptBase = new ktools.Script("maps_mapstraction_base", crossDomainTargetUrl+"shitdata/graphics/KolorMap/lib/mxn.basemap.js", [mapstractionScript], false);
			var mapstractionScriptCore = new ktools.Script("maps_mapstraction_core", crossDomainTargetUrl+"shitdata/graphics/KolorMap/lib/mxn.core.js"+refreshIE, [mapstractionScriptBase], false);
			var mapstractionScriptCoreLayer1 = new ktools.Script("maps_mapstraction_core_layer1", crossDomainTargetUrl+"shitdata/graphics/KolorMap/lib/"+mapApiOrder[0][3]+refreshIE, [mapstractionScriptCore], false);
		}
		
		var kolorMapScript = null;
		if (useGoogleLabelsClass) {
			var googleLabelsScript = new ktools.Script("maps_google_labels", crossDomainTargetUrl+"shitdata/graphics/KolorMap/lib/mxn.googlev3.core.labels.js", [mapstractionScriptCoreLayer1], false);
			kolorMapScript = new ktools.Script("kolormap", crossDomainTargetUrl+"shitdata/graphics/KolorMap/js/KolorMap.min.js", [googleLabelsScript], true);
		} else {
			kolorMapScript = new ktools.Script("kolormap", crossDomainTargetUrl+"shitdata/graphics/KolorMap/js/KolorMap.min.js", [mapstractionScriptCoreLayer1], true);
		}
		mapPlugin.addScript(kolorMapScript);
		
		var kolorMapCSS = new ktools.CssStyle("kolormapCSS", crossDomainTargetUrl+"shitdata/graphics/KolorMap/js/kolorMap.css");
...
function initKolorMapOnReady(pluginName, defaultMapLayer, mapAreaDiv) {
	...
	kolorMap.setGraphicsUrl(crossDomainTargetUrl+"shitdata/graphics/"+pluginName.toLowerCase()+"/");
...
function addKolorArea(pPlugID)
{
	if(typeof ktools.KolorPluginList.getInstance().getPlugin(pPlugID) == "undefined")
	{
		var kolorAreaCSS = new ktools.CssStyle("KolorAreaCSS", crossDomainTargetUrl+"shitdata/graphics/KolorArea/kolorArea.css");
		var kolorAreaJS = new ktools.Script("KolorAreaJS", crossDomainTargetUrl+"shitdata/graphics/KolorArea/KolorArea.min.js", [], true);
